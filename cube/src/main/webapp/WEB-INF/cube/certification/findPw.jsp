...
<div class="col-lg-6">
    <div class="p-5">
		...
		<div class="form-group">
		    <input type="text" class="form-control form-control-user" id="userId" placeholder="아이디를 입력하세요">
        </div>
       ...
       <!-- 사번 -->
        <div class="form-group">
            <input type="text" class="form-control form-control-user" id="userNum" placeholder="사번을 입력하세요">
        </div>
        ...
        <!-- 이름 -->
        <div class="form-group">
           <input type="text" class="form-control form-control-user" id="userName" placeholder="이름을 입력하세요">
       	</div>
        ...
        <!-- 휴대전화번호 -->
	    <div class="form-group">
            <input type="text" class="form-control form-control-user" id="userMobile" placeholder="휴대전화 번호를 입력하세요">
        </div>
