...
<div class="card-body p-0">
	...
	<div class="row">
		...
		<div class="text-center">
			<h1 class="h4 text-gray-900 mb-2">아이디를 잊었니?</h1>
			<p class="mb-4">아이디를 잊으셨나요 아이디를 찾아보세요</p>
		</div>
	
		<div class="form-group">
			<input type="text" class="form-control form-control-user"
				id="userNum" name="userNum" placeholder="사번을 입력해 주세요">
		</div>
		...
		<div class="form-group">
			<input type="text" class="form-control form-control-user"
				id="userName" name="userName" placeholder="이름을 입력해 주세요">
		</div>
		...
		<div class="form-group">
		<button id="btn-findId" class="btn btn-secondary btn-user btn-block">아이디 찾기</button>
