...
<body>
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item active"><a class="nav-link" href="/receivemail_list">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/importantmail_list">보낸 중요 메일함</a>
                        <a class="collapse-item" href="/importantmail_list">받은 중요 메일함</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/isdeletemail_list">보낸 삭제 메일함</a>
                        <a class="collapse-item" href="/isdeletemail_list">받은 삭제 메일함</a>
                    </div>
                </div>
            </li>
