...
public class MyController {
	...
	@PostMapping("/my_profileCheckPw")
	public @ResponseBody ResponseDTO<?> myProfileCheckPw(@RequestBody Users user, HttpSession session, Model model) {
		System.out.println("마일 비밀번호 확인 요청됨");
